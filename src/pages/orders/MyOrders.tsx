...
const MyOrders = () => {
    ...
    const itemsPerPage = 4
      ...
      const filterOrders =  myOrders?.filter((order)=>selectedItem === OrderStatus.All ||order.orderStatus === selectedItem)
    ...
    const currentOrders = filterOrders && filterOrders.length > 0
    ? filterOrders.slice(indexOfFirstOrder, indexOfLastOrder)
    : [];
                ...
                <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            ...
                            currentOrders?.length > 0 && currentOrders.map((order)=>{
                                return (
                                    ...
                                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                          ...
                                          <p  className="text-blue-900 whitespace-no-wrap" style={{textDecoration: 'underline', cursor: 'pointer'}} >  {order.id}</p>
                                          </Link>
                                       </td>
                                       <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    ...
                    <div
                        ...
                        <span className="text-xs xs:text-sm text-gray-900">
                            Showing {indexOfFirstOrder + 1} to {Math.min(indexOfLastOrder, filterOrders?.length)}
                        </span>
