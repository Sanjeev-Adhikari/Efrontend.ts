...
import { Props, UserDataType } from "../types/types"
        ...
        <div className="relative mx-auto flex min-h-dvh w-full max-w-10xl items-center justify-center overflow-hidden p-4 lg:p-8">
          ...
          <section className="w-full max-w-xl py-6">
            ...
            <header className="mb-4 text-center">
              <h1 className="text-lg font-medium text-blue-500 dark:text-blue-500">
                Welcome, please {type === "register" ? "sign up" : "login"}  to your Profile
              </h1>
            </header>
            <div className="flex flex-col overflow-hidden rounded-lg bg-white shadow-sm dark:bg-gray-800 dark:text-gray-100">
              <div className="grow p-5 mt-5 md:px-16 md:py-4">
                <form
                  ...
                  <div>
                   {
                    ...
                    >
                      ...
                      <span>{type === 'register' ? "sign in" : "login"}</span>
                    </button>
              ...
              {type === 'login' ? (
                <div className="grow bg-gray-50 p-2 mb-4 text-center text-sm  dark:bg-gray-700/50">
                ...
                <div className="grow bg-gray-50 p-2 mb-4 text-center text-sm md:px-0 dark:bg-gray-700/50">
